...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form_w_text_field_boxes,
                                                                                                                                                       tag:
                                                                                                                                                         'div',
                                                                                                                                                       class:
                                                                                                                                                         'form-group',
  ...
  config.wrappers :inline_form_w_text_field_boxes,
                  tag: 'span',
  ...
  config.wrappers :input_group,
    ...
    b.wrapper :input_group_tag,
              tag: 'div', class: 'input-group textfield-box' do |ba|
      ba.optional :prepend
      ba.use :input,
             class: 'form-control',
             error_class: 'is-invalid',
